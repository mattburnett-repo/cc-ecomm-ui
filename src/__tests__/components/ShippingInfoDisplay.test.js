...
describe('<ShippingInfo /> component tests', () => {
    beforeEach(() => render(<ThemeProvider theme= { theme }><Provider store={store}><ShippingInfoDisplay savedAddresses={mockSavedAddreses} handlers={handlers()} /></Provider></ThemeProvider>));
    ...
    it('creates a snapshot', () => {
        const tree = renderer.create(<ThemeProvider theme= { theme }><Provider store={store}><ShippingInfoDisplay savedAddresses={mockSavedAddreses} handlers={handlers()} /></Provider></ThemeProvider>).toJSON();

...
describe('<BrowseSearchDisplay /> component tests', () => {
    beforeEach(() => render(<ThemeProvider theme= { theme }><BrowseSearchDisplay data={ mockProductCategories } handlers={mockHandlers()} /></ThemeProvider>));
    ...
    it('creates a snapshot', () => {
        const tree = renderer.create(<ThemeProvider theme= { theme }><BrowseSearchDisplay data={ mockProductCategories } handlers={mockHandlers()} /></ThemeProvider>).toJSON();
